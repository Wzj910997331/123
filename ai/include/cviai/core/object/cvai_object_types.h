 ...
 *  @brief Gives the hint to object detection inference which type of object
 * should be detected.
 */
typedef enum {
  CVI_DET_TYPE_ALL = 0,
...
typedef enum {
  CVI_AI_DET_GROUP_ALL =
      GROUP_ID(CVI_AI_DET_TYPE_PERSON, CVI_AI_DET_TYPE_HAIR_BRUSH),
  CVI_AI_DET_GROUP_PERSON =
      GROUP_ID(CVI_AI_DET_TYPE_PERSON, CVI_AI_DET_TYPE_PERSON),
  CVI_AI_DET_GROUP_VEHICLE =
      GROUP_ID(CVI_AI_DET_TYPE_BICYCLE, CVI_AI_DET_TYPE_BOAT),
  CVI_AI_DET_GROUP_OUTDOOR =
      GROUP_ID(CVI_AI_DET_TYPE_TRAFFIC_LIGHT, CVI_AI_DET_TYPE_BENCH),
  CVI_AI_DET_GROUP_ANIMAL =
      GROUP_ID(CVI_AI_DET_TYPE_BIRD, CVI_AI_DET_TYPE_GIRAFFE),
  CVI_AI_DET_GROUP_ACCESSORY =
      GROUP_ID(CVI_AI_DET_TYPE_HAT, CVI_AI_DET_TYPE_SUITCASE),
  CVI_AI_DET_GROUP_SPORTS =
      GROUP_ID(CVI_AI_DET_TYPE_FRISBEE, CVI_AI_DET_TYPE_TENNIS_RACKET),
  CVI_AI_DET_GROUP_KITCHEN =
      GROUP_ID(CVI_AI_DET_TYPE_BOTTLE, CVI_AI_DET_TYPE_BOWL),
  CVI_AI_DET_GROUP_FOOD =
      GROUP_ID(CVI_AI_DET_TYPE_BANANA, CVI_AI_DET_TYPE_CAKE),
  CVI_AI_DET_GROUP_FURNITURE =
      GROUP_ID(CVI_AI_DET_TYPE_CHAIR, CVI_AI_DET_TYPE_DOOR),
  CVI_AI_DET_GROUP_ELECTRONIC =
      GROUP_ID(CVI_AI_DET_TYPE_TV_MONITOR, CVI_AI_DET_TYPE_CELL_PHONE),
  CVI_AI_DET_GROUP_APPLIANCE =
      GROUP_ID(CVI_AI_DET_TYPE_MICROWAVE, CVI_AI_DET_TYPE_BLENDER),
  CVI_AI_DET_GROUP_INDOOR =
      GROUP_ID(CVI_AI_DET_TYPE_BOOK, CVI_AI_DET_TYPE_HAIR_BRUSH),
