...
#define FACE_RETINA_PATH                                                       \
  "/mnt/data/ai_lib/ai_models_output/retinaface_mnet0.25_608.cvimodel"
#define OBJECT_DETECT_MODEL_PATH                                               \
  "/mnt/data/ai_lib/ai_models_output/mobiledetv2-lite.cvimodel"
#define FACE_RECOGNITION_PATH                                                  \
  "/mnt/data/ai_lib/ai_models_output/cviface-v5-s.cvimodel"
#define FACE_QUALITY_PATH                                                      \
  "/mnt/data/ai_lib/ai_models_output/fqnet-v5_shufflenetv2-softmax.cvimodel"
#define FACE_ATTRIBUTE_PATH                                                    \
  "/mnt/data/ai_lib/ai_models_output/cviface-v3-attribute.cvimodel"
#define PD_MODEL_PATH                                                          \
  "/mnt/data/ai_lib/ai_models_output/mobiledetv2-pedestrian-d0.cvimodel"
...
typedef enum {
  CVIAPP_AI_FACE_CAPTURE,
  CVIAPP_AI_OBJECT_DETECTION,
  CVIAPP_AI_FACE_DETECION,
  CVIAPP_AI_MODEL_MAX
} CVIAPP_AI_MODEL_E;
...
typedef uint8_t (*CVIAPP_AI_GET_FRAME_FUN_T)(
    uint8_t u8Chn, VIDEO_FRAME_INFO_S *pstVideoFrameInfo);
typedef void (*CVIAPP_AI_RELEASE_FRAME_FUN_T)(
    uint8_t u8Chn, VIDEO_FRAME_INFO_S *pstVideoFrameInfo);
typedef void (*CVIAPP_AI_NOTIFY_FUN_T)(uint8_t u8Chn,
                                       CVIAPP_AiResult_S *pResult);
...
CVI_ERROR_CODE_E _CVIAPP_AiSearchMatchFaceCount(const char *img_dir,
                                                int *matchNum,
                                                int *faceLibIndexs);
