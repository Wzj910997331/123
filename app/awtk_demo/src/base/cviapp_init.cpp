...
static void vb_pool_init(void)
{
    ...
    stVbConfig.astCommPool[0].u32BlkSize = COMMON_GetPicBufferSize(INPUT_VIDEO_MAX_WIDTH, INPUT_VIDEO_MAX_HEIGHT,\
    ...
    stVbConfig.astCommPool[1].u32BlkSize = COMMON_GetPicBufferSize(INPUT_VIDEO_MAX_WIDTH, INPUT_VIDEO_MAX_HEIGHT, PIXEL_FORMAT_RGB_888, DATA_BITWIDTH_8,
                                        COMPRESS_MODE_NONE, DEFAULT_ALIGN);
    stVbConfig.astCommPool[1].u32BlkCnt = 5;
    stVbConfig.astCommPool[2].u32BlkSize = COMMON_GetPicBufferSize(INPUT_VIDEO_MAX_WIDTH, INPUT_VIDEO_MAX_HEIGHT, PIXEL_FORMAT_RGB_888, DATA_BITWIDTH_8,
                                        COMPRESS_MODE_NONE, DEFAULT_ALIGN);
