 ...
 */
static CVIAPP_RtspPlayerManager_S
    g_rtspPlayerMng_list[CVIAPP_AIBOX_DEVICE_NUM_MAX];
...
CVI_ERROR_CODE_E CVIAPP_SYS_DeInit() { return E_CVI_ERROR_CODE_SUCC; }
...
CVI_ERROR_CODE_E CVIAPP_StartRtspPlayChn(
  ...
  case E_CVIAPP_WM_TYPE_2_SPLIT:
    pPlayerParam->m_u32InputVideoWidth = CVIAPP_DEFAULT_GUI_WIDTH;
    pPlayerParam->m_u32InputVideoHeight = CVIAPP_DEFAULT_GUI_HEIGHT >> 1;
    break;

  case E_CVIAPP_WM_TYPE_4_SPLIT:
    pPlayerParam->m_u32InputVideoWidth = CVIAPP_DEFAULT_GUI_WIDTH >> 1;
    pPlayerParam->m_u32InputVideoHeight = CVIAPP_DEFAULT_GUI_HEIGHT >> 1;
    break;
...
CVI_ERROR_CODE_E CVIAPP_StartPreview() {
  ...
  rtspUrl = "rtsp://192.168.1.107:554/cam/"
            "realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif";
  CVIAPP_StartRtspPlayChn(0, rtspUrl, "admin", "L2A34AC7",
                          E_CVIAPP_WM_TYPE_4_SPLIT, 0);

  rtspUrl = "rtsp://192.168.1.108:554/cam/"
            "realmonitor?channel=1s&subtype=0&unicast=true&proto=Onvif";
  CVIAPP_StartRtspPlayChn(1, rtspUrl, "admin", "cvitek123",
                          E_CVIAPP_WM_TYPE_4_SPLIT, 1);

  rtspUrl = "rtsp://192.168.1.106:554/cam/"
            "realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif";

  CVIAPP_StartRtspPlayChn(2, rtspUrl, "admin", "L2E4E1D9",
                          E_CVIAPP_WM_TYPE_4_SPLIT, 2);

  rtspUrl = "rtsp://admin:cvitek1234@192.168.1.80:554/cam/"
            "realmonitor?channel=1&subtype=1&unicast=true&proto=Onvif";
