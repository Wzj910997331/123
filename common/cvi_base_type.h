...
public:
  ...
  static CVI_ERROR_CODE_E CVI_Config_IniGet(string iniFilePath, string section,
                                            string key, string *value);
  static CVI_ERROR_CODE_E CVI_Config_IniSet(string iniFilePath, string section,
                                            string key, string value);
  static CVI_ERROR_CODE_E CVI_Config_IniSetInTmp(string section, string key,
                                                 string value);
  static CVI_ERROR_CODE_E CVI_Config_SizeConvert(cvi_uint32 &actualSize,
                                                 cvi_uint32 &convertSize);
  static CVI_ERROR_CODE_E
  CVI_Config_TimeStampConvert(cvi_uint64 &actualTimeStamp,
                              cvi_uint64 &convertTimeStamp);
  static cvi_int32 CVI_Config_H264ParseSps(const cvi_uint8 *data,
                                           cvi_uint32 dataSize,
...
public:
  ...
  CVI_Rect_C(cvi_uint16 X = 0, cvi_uint16 Y = 0, cvi_uint16 W = 0,
             cvi_uint16 H = 0)
...
public:
  ...
  CVI_IntRange_C(cvi_int32 min = 0, cvi_int32 max = 0)
      : m_i32Min(min), m_i32Max(max) {}
};
...
public:
  ...
  CVI_FloatRange_C(cvi_float min = 0, cvi_float max = 0)
