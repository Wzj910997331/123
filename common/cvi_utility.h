...
public:
    ...
    {
        char IPv4_str[16] = {0};
        sprintf(IPv4_str,"%d.%d.%d.%d",pu8IPV4[0],pu8IPV4[1],pu8IPV4[2],pu8IPV4[3]);
    ...
    static string Md5Decode(string strMd5Content)
    {
        return strMd5Content;
    }
    static cvi_uint32 GenerateUniqueId()
    {
        return 0x01;
    }
    static cvi_uint32 GeneratUniqueMsgId()
    {
        return 0x01;
    }
    static cvi_uint64 GeneratUniqueDBId()
    {
        return 0x01;
    }
    static cvi_uint64 GeneratUniqueDiskId()
    {
        return 0x01;
    }
    static cvi_uint64 GenerateGroupId()
    {
        return 0x01;
    }
    static cvi_uint64 GenerateUserId()
    {
        return 0x01;
    }
